...
# An integration of everything I have learned
...
# ** does exponents, * does multiplication, / divides
# + adds, % does modulus, // does floor division
# I intend to add to this project even after being finished with the class
# If there are unused classes or objects please ignore
# Enjoy
import random
import time

print("Welcome to my Integration Project!", sep='\n')
...
def Choice_1():
    ...
    if choice_1 == "1":
        print(
            "The guard opens the door and draws their sword, Prepare! \n")
        battlestate()
        ...
        if keyChance > 2:
            print(
                "You open the door,but the guard looks over and attacks")
            battlestate()
        else:
            print("The guard notices!\n He opens the door and attacks!")
            battlestate()
    elif choice_1 == "3":
        print("You talk to the guard, what do you say \n")
        print(
            "When you open your mouth, the guard gets irritated and walks off")
...
def drawer_puzzle():
    print("You see a locked drawer you spot plates lock down when pressed")
